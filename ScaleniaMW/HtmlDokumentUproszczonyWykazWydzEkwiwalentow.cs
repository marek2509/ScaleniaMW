...
namespace ScaleniaMW
{
    static class HtmlDokumentUproszczonyWykazWydzEkwiwalentow
    {
        ...
        public const string HTML_PoczatekWykazyWydzEkwiwalentow = "<!DOCTYPE html> <html> <head>  <meta charset=\"windows-1250\"> <meta name=Generator content=\"Microsoft Word 12 (filtered)\"> <style> body { font-family: \"Arial Narrow\", Arial, sans-serif; font-style: italic; font-size: 11pt; }</style> </head> <body lang=PL>";// <div class=WordSection1>";
        ...
        public static String GenerujWykazWE(JR_Nowa JednoskaRejNowa)
        {
            ...
            dokHTML.AppendLine("<div style=\"border-bottom: 2px solid black;\"><br /><span style=\"margin-bottom: 0; padding: 0; \" >Właściciele i władający</span></div>");
            ...
            //{
                ...
                //dokHTML.AppendLine("<tr><td style =\"border: 1px solid black; text-align: center; \">" + '-' + "</td><td style =\"border: 1px solid black; text-align: right; margin-right:5px; \">" + "-" + "</td><td style =\"border: 1px solid black; text-align: right; margin-right:5px; color: green; \" >" + "-" + "</td><td style =\"border: 1px solid black; text-align: center; \">" + "-" + "</td>");
                            ...
                            dokHTML.AppendLine("<tr><td style =\"border: 1px solid black; text-align: center; \">" + nrobr + "</td><td style =\"border: 1px solid black; text-align: center;  color: red; \">" + nrdzPo + "</td><td style =\"border: 1px solid black; text-align: right; margin-right:5px; \">" + powDzialkiPo + "</td><td style =\"border: 1px solid black; text-align: right; margin-right:5px; color: green; \" >" + wartPo + "</td><td style =\"border: 1px solid black; text-align: center; \">" + kwPo + "</td></tr>");

                        }

            //dokHTML.AppendLine("<tr><td style =\"border: 1px solid black; text-align: right; margin-right:5px; \">" + "<i><b>Razem:</i></b>" + "</td><td style =\"border: 1px solid black; text-align: right; margin-right:5px; \"><b>" + "x" + "</b></td><td style =\"border: 1px solid black; text-align: right; margin-right:5px; color: green; \" ><b>" + "X" + "</b></td><td style =\"border: 1px solid black; text-align: center; \"></td>");
            dokHTML.AppendLine("<tr><td style =\"border: none; text-align: center; \"></td><td style =\"border: none; text-align: right; margin-right:5px; \">" + "<i><b>Razem:</b></i>" + "</td><td style =\"border: 1px solid black; text-align: right; margin-right:5px; \"><b>" + JednoskaRejNowa.Dzialki_Nowe.Sum(x => x.PowDz).ToString("F4", CultureInfo.InvariantCulture) + "</b></td><td style =\"border: 1px solid black; text-align: right; margin-right:5px; color: green; \" ><b>" + SumaWartosciPo.ToString("F2", CultureInfo.InvariantCulture) + "</b></td><td style =\"border: none; text-align: center; \"></td></tr>");
                    //}
                    //else
                    //{
